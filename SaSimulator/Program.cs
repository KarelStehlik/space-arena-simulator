...
namespace SaSimulator
{
    ...
    internal class Program
    {
        static void RunMain(Options o)
        {
            ...
            if (o.Graphics)
            {
                Game game = new(file, o.Graphics, (o.Timeout == 0 ? float.PositiveInfinity : o.Timeout).Seconds(), rng.Next(), o.DeltaTime.Seconds());
            ...
            for (int t = 0; t < 100; t++)
            {
                ...
                {
                    ThreadPool.QueueUserWorkItem(Simulate, new SimulationInfo(file, o, rng.Next(), results));
                }
        ...
        static void Simulate(object? simulationInfo)
        {
            ...
            Game game = new(info.ships, info.options.Graphics,
